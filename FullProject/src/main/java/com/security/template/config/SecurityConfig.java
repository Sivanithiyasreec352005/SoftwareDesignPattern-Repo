...
public class SecurityConfig {
    ...
    public static final List<String> ORIGINS = Arrays.asList("http://localhost:5173"); // Updated origin

    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                .cors(corsConfiguration -> corsConfiguration.configurationSource(corsConfigurationSource())) // Fixed method name
